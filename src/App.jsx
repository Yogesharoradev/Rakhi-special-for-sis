...
const memories = [
  {
    ...
    kicker: "CHAPTER 01",
    text: "Hum teen ki kahani kabhi shaant reh hi nahi sakti thi. Do bhai aur beech mein humari sabse choti behen — jise dono bhai protect bhi karte the aur mauka milte hi tang bhi. Ghar mein kiski baat maani jayegi, TV ka remote kiske paas rahega, last wali mithai kaun khayega… choti choti baaton par full court case lag jaata tha. Aur sabse funny baat? Har baar hum teen alag sides par hote the, lekin thodi der baad wahi teen log saath baith ke has rahe hote the.",
    detail:
      "Bachpan mein humein lagta tha ki ye sab normal hai. Humein kya pata tha ki ek din yehi normal moments sabse zyada yaad aayenge. Woh bina plan ke saath baithna, ek dusre ki complain karna, mummy papa se bachne ke liye team bana lena, aur phir kisi ek ki hasi dekh kar sabka hasna — ye humari asli memories hain. Hum teen alag personalities hain, lekin pata nahi kaise ek saath milkar ek complete madness ban jaate hain.",
  },
  {
    image:
    ...
    kicker: "CHAPTER 02",
    text: "Tu hum dono se choti thi, isliye naturally ghar ki unofficial VIP bhi thi. Kabhi dono bhai tere against team bana lete the, kabhi tu dono bhaiyon ko alag alag use karke apna kaam nikalwa leti thi. Aur sach bolun toh, hum dono ko pata hota tha ki tu drama kar rahi hai… phir bhi maan jaate the. Shayad choti behen hone ka yehi special power hota hai.",
    detail:
      "Time ke saath tu badi hoti gayi aur hum dono bhai bhi apni apni duniya mein busy hote gaye. Lekin humari equation ka ek ajeeb sa rule hamesha raha — kitna bhi time ho jaye, kitni bhi doori ho, ek call ya ek random message se hum teen wahi purane version mein aa jaate hain. Ek bhai serious advice dega, doosra faltu joke marega, aur tu dono ko ignore karke apni baat manwa legi. Basically, kuch bhi change nahi hua.",
  },
  {
    image:
    ...
    kicker: "CHAPTER 03",
    text: "Har family ke paas kuch aise jokes aur references hote hain jo bahar wale kabhi samajh nahi sakte. Humare paas toh poori dictionary hai. Ek look, ek word, ek purani incident ki aadhi line — aur hum teen samajh jaate hain ki saamne wala kya bol raha hai. Kabhi koi baat itni funny nahi hoti, phir bhi hum teen usko yaad karke saalon tak haste rehte hain.",
    detail:
      "Yehi cheez distance ke baad aur special lagti hai. Australia mein tu apni life jee rahi hai, hum yahan apni. Time zones alag hain, routines alag hain, lekin jab hum teen call par aa jaate hain toh lagta hi nahi ki itna time beet gaya. Humari language kisi country ki nahi hai — woh bas hum teen ki hai. Aur honestly, I hope life kitni bhi busy ho jaye, ye language kabhi purani na ho.",
  },
  {
    image:
    ...
    kicker: "CHAPTER 04",
    text: "Phir ek din tu Australia chali gayi. Excitement bhi tha, pride bhi tha, aur thoda sa woh ajeeb feeling bhi — ki ab hum teen ek hi ghar mein nahi honge. Pehle kisi room se awaaz aa jaati thi aur pata hota tha tu kya kar rahi hai. Ab kabhi phone uthate hue pehle time dekhna padta hai ki Australia mein kitne baje hain. Distance sach mein bada hai, lekin humari story usse choti nahi hui.",
    detail:
      "Dono bhaiyon ki taraf se ek baat hamesha yaad rakhna: humein tere upar genuinely bahut pride hai. Tu apni life build kar rahi hai, naye experiences face kar rahi hai, aur ghar se itni door rehkar apne liye kuch naya bana rahi hai. Haan, kabhi kabhi miss karte hain. Kabhi koi funny baat hoti hai aur automatically lagta hai tujhe batana hai. Lekin distance ke beech bhi ek cheez same hai — tu humari choti behen thi, hai, aur rahegi. Australia bas map par door hai, humare liye nahi.",
  },
];
const chapters = [
  [
    ...
    <main>
      ...
      <section id="story" className="intro section-pad">
        <div className="story-intro">
          ...
          <div className="long-copy">
            ...
            <p>
              Phir life badli. Tu choti se badi hui, and dekhte dekhte shadi bhi
              ho gyi, aur tu australia chli gyi . Tab samajh aaya ki family ki
              value bade occasions mein nahi, un choti choti everyday moments
              mein hoti hai jinke baare mein humne kabhi socha bhi nahi tha.
            </p>
          </div>
      ...
      <section id="memories" className="memories section-pad">
        <div className="section-heading">
          ...
          <h2>
            Click a photo.
            <br />
            <em>Stay for our story.</em>
          </h2>
          <p>
            Har memory mein hum teen ki thodi si bakchodi aur bahut saara pyaar
            hai.
          </p>
        </div>
            ...
            >
              ...
              <div>
                ...
                <p className="timeline-extra">
                  Kabhi loud, kabhi emotional, kabhi completely pagal. But
                  always ours.
                </p>
              </div>
            </motion.div>
      ...
      <section className="fun-section section-pad">
        <div className="section-heading">
          ...
          <h2>
            Proof that <em>hum teen normal nahi hain.</em> 😂
          </h2>
          <p>Do bhai + ek choti behen = impossible combination.</p>
        </div>
        <div className="fun-grid">
          {[
            ["Choti behen ka drama", "CERTIFIED"],
            ["Do bhai ki advice", "UNSOLICITED"],
            ["“Bas 2 minute”", "NEVER 2 MINUTES"],
            ["Group chat chaos", "24 × 7"],
            ["Ek joke, teen hasi", "LOUDLY"],
            ["Favourite little sister", "UNFORTUNATELY ❤️"],
          ].map(([a, b], i) => (
            <motion.div
              className="fun-card"
              key={a}
      ...
      <section className="map-section section-pad">
        ...
        <div className="map-copy">
          ...
          <p>
            ...
            yahan se tere liye genuinely proud hain. Jab bhi ghar yaad aaye,
            yaad rakh — India mein do log hain jo tujhe irritate karne ke liye
            permanently available hain.
          </p>
          <div className="route">
          ...
          >
            ...
            >
              ...
              <p>
                ...
                banana easy nahi hota. Hum shayad har difficult moment mein
