// Story copy only — visual design, animations and layout stay untouched.
// Replace these later with your real names, memories and inside jokes.
const COPY = {
  welcome: {
    line: 'Hum teen ki taraf se, sabse choti wali ke liye 🇦🇺',
    title: 'Headphones laga le, choti.',
    sub: 'Jaldi mat karna. Yeh page hum dono bhaiyon ne milke tere liye banaya hai — thoda pyaar, thodi bakchodi, aur bahut saari purani yaadein.'
  },
  hero: {
  ...
  intro: {
    ...
    button: 'Chal, thoda peeche chalte hain →'
  },
  memories: {
  ...
  chapters: [
    ['Bachpan ka chaos', 'Do bhai aur ek choti behen — ghar kabhi genuinely quiet nahi raha.'],
    ['Hum teen', 'Ladai kisi ek ki ho, side hamesha dono ki li jaati thi… mostly galat side. 😂'],
    ['Badi ho gayi tu', 'Kab choti si behen apni duniya banane lagi, pata hi nahi chala.'],
    ['Australia wala chapter', 'Tu door chali gayi, par hamari bakchodi ka time-zone nahi badla.'],
    ['Hamesha hum teen', 'Countries alag ho sakti hain, ghar alag ho sakta hai — hum teen nahi badlenge.']
  ],
  timeline: [
    ['Woh din', 'Jab hum teen ek hi ghar mein the aur distance naam ki koi cheez nahi thi.'],
    ['Bachpan', 'Choti choti fights, bade bade dramas aur har din koi naya kand.'],
    ['Growing up', 'Hum sab apni-apni life mein busy hote gaye, par bond wahi raha.'],
    ['Australia', 'Tu naye desh mein apni life bana rahi hai aur hum dono yahan se tere liye cheer kar rahe hain.'],
    ['Always', 'Chahe kitni bhi door ho, call karo toh wahi purani choti behen wali feeling aa jaati hai.']
  ],
  fun: {
  ...
  funCards: [
    ['Charger le jaati hai', 'PHIR MILTA NAHI'],
    ['“Bas 2 minute” bolti hai', '45 MINUTES LATER'],
    ['Dono bhaiyon ko order karti hai', 'BOSS LADY'],
    ['Ladai mein innocent banti hai', 'NICE TRY 😂'],
    ['Apni hi joke pe hasti hai', 'LOUDLY'],
    ['Sabse choti hai', 'SABSE ZYADA PYARI ❤️']
  ],
  distance: {
    label: 'THE DISTANCE',
  ...
  letterParagraphs: [
    'Choti, jab hum teen bachpan mein the na, tab humein bilkul idea nahi tha ki life humein alag-alag directions mein le jayegi. Tab toh bas ye matter karta tha ki kiski galti hai, kisne kya toda, aur mummy ko kya bolna hai. 😂 Aaj unhi choti choti cheezon ko yaad karke smile aa jaati hai.',
    'Tu hum dono se choti hai, aur shayad isi wajah se hum dono ko hamesha lagta raha ki tujhe protect karna hamari responsibility hai. Lekin sach bolun toh tu bhi kam strong nahi hai. Australia jaakar apni life start karna, naye logon ke beech adjust karna, difficult days handle karna — we are genuinely proud of you.',
    'Haan, tu door hai. Kabhi kabhi miss bhi hoti hai. Ghar mein koi random baat hoti hai aur lagta hai ki “isko call karke batate hain.” Phir yaad aata hai ki tu doosre side of the world hai. Lekin call connect hote hi woh distance somehow disappear ho jaata hai.',
    'Rakhi ka matlab sirf ek thread nahi hota. Hamare liye woh reminder hai ki hum teen chahe duniya ke kisi bhi corner mein chale jaayein, ek doosre ke liye wahi rahenge. Tu hamari choti behen hai — forever. Hum dono tere annoying bade bhai hain — unfortunately, forever. 😂❤️',
    'Apni life full enjoy kar, dreams chase kar, mistakes kar, grow kar aur kabhi ye mat sochna ki ghar bahut door hai. Ghar ke do pagal bhai yahin hain. Jab bhi zarurat ho, call kar lena. Aur haan, Australia mein rehkar humein bhool mat jaana. 😭',
    'Happy Raksha Bandhan, choti. From both of us — bahut saara pyaar. 🫶'
  ],
  finale: {
